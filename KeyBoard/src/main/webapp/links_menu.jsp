...
<div class="opcoes_menu">
    ...
    <span class="text_spans_menu span_menu_minha_conta"><a href="pedido?operacao=CONSULTAR&cliente_id=1">Minha Conta</a></span>
    <span class="text_spans_menu span_menu_lista_cliente"><a href="cliente?operacao=CONSULTAR">Lista de Cliente</a></span>
    <span class="text_spans_menu span_menu_lista_teclado">Lista de Teclado</span>
    <span class="text_spans_menu span_menu_cadastro_teclado">Cadastro de Teclado</span>
    <span class="text_spans_menu span_menu_estoque">Estoque</span>
